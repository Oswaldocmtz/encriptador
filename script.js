function encriptar(){
    ...
    document.getElementById("textoDescifrado").innerHTML = textoCifrado;

    document.getElementById("btnCopiar").style.display = "show";
    document.getElementById("btnCopiar").style.display = "inherit";

    document.getElementById("imagen-contenedor").style.display = "inherit";
    document.getElementById("imagen-contenedor").style.display = "show";
}
